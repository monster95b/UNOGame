...
import Interfaces.MyUNOConstants;

public class MyTablePanel extends JPanel implements MyGameConstants {
	
	private UnoCard topCard;	
	private JPanel table;
	
	public MyTablePanel(UnoCard firstCard){
		setOpaque(false);
	...
	public void setBackgroundColor(UnoCard playedCard){
		...
		if(playedCard.getType()==WILD)
			background = ((WildCards) playedCard).getWildColor();
		else
